...
export const widgetDefinitions: WidgetDefinition[] = [
  ...
  { id: "main.node.choinka", moduleId: "main", title: "choinka", description: "Water-level and pump node status", icon: TreePine, component: Choinka, singleton: true, sizes: statusNode, capabilities: ["mesh.read"] },
