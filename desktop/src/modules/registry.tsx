...
export const widgetDefinitions: WidgetDefinition[] = [
  { id: "main.connection", moduleId: "main", title: "Connection", description: "KeeLink root, refresh and command controls", icon: Cable, component: Connection, singleton: true, sizes: full, capabilities: ["mesh.read", "mesh.command"] },
  ...
  { id: "main.lighting", moduleId: "main", title: "Lighting", description: "Lighting nodes and effects", icon: Lightbulb, component: Lighting, singleton: true, sizes: full, capabilities: ["mesh.command"] },
  { id: "main.climate", moduleId: "main", title: "Climate", description: "Humidifier, heater and water controls", icon: Heater, component: Climate, singleton: true, sizes: full, capabilities: ["mesh.command"] },
